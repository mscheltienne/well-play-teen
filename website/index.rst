...
.. tab-set::
    ...
    .. tab-item:: FAQ
        ...
        .. dropdown:: Où se trouve le laboratoire de L’université ?
            ...
            Il vous est possible de choisir le lieu des RDV à l’université entre :

            - Le campus biotech (Chemin des Mines 9, Genève)
            - Unimail (Boulevard du Pont d’Arve 40, Genève)

            Ce lieu sera convenu avec vous au début de l’étude.
