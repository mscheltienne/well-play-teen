(dom_loaded => {
    ...
    function updateSidebarAttributesVisible() {
        sidebar_button.setAttribute('title', "Réduire la barre latérale");
        sidebar_button.setAttribute('aria-label', "Réduire la barre latérale");
    ...
    function updateSidebarAttributesHidden() {
        sidebar_button.setAttribute('title', "Agrandir la barre latérale");
        sidebar_button.setAttribute('aria-label', "Agrandir la barre latérale");
